...
const menuItems = [
  ...
  { name: "Services", dropdown: ["Mobile App Development", "Web Development", "Web App Development", "Software Development", "Game Development", "Desktop App Development", "API Development", "Cloud Development", "Blockchain Development", "DevOps Services", "UI/UX Design", "E-commerce Development"] },
        ...
        <div className="max-w-[1440px] mx-auto flex items-center justify-between px-6 md:px-10 text-white w-full relative">
          ...
          <div className="hidden lg:flex items-center gap-10 text-[16px] font-semibold text-gray-200 absolute left-1/2 -translate-x-1/2">
            ...
            <div className="relative group/dropdown">
              ...
              <div className="absolute top-full left-0 w-[280px] opacity-0 invisible translate-y-2 group-hover/dropdown:opacity-100 group-hover/dropdown:visible group-hover/dropdown:translate-y-0 transition-all duration-500 z-50 pt-2">
                <div className="bg-[#0b0612]/90 backdrop-blur-xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden rounded-xl max-h-[400px] overflow-y-auto">
                  <NavLink
                  ...
                  <NavLink
                    to="/services/desktop-app-development"
                    className="block px-6 py-4 text-[15px] font-medium text-white hover:bg-white/5 transition-colors border-b border-white/5"
                  >
