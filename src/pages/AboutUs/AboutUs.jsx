          ...
          <div className="relative rounded-3xl overflow-hidden bg-[#0A0510]/40 backdrop-blur-xl border border-white/10 p-8 md:p-16 lg:p-24 shadow-2xl">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-10 max-w-2xl">
                ...
                digital world. Our focus is on delivering high-quality software
                solutions, modern websites, and result-driven SEO strategies
            ...
            <motion.div {...fadeIn}>
              ...
              <div className="space-y-6">
                <p className="text-gray-300 text-lg leading-relaxed">
                  We specialize in website development, custom software
                  solutions, SEO optimization, and digital growth strategies.
                  Our goal is to help startups, businesses, and organizations
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-8 leading-tight">
                We don't just build software or websites — we create{" "}
              ...
              <p className="text-xl text-gray-400 mb-12 max-w-3xl mx-auto">
                ...
                world? Let's build something extraordinary together.
              </p>
