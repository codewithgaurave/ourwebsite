        ...
        <section className="px-6 md:px-10 max-w-[1440px] mx-auto mb-20">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto">
              ...
              is ready to help you with software development, website creation,
              SEO services, and digital growth strategies.
            </p>
          </motion.div>
        </section>
            ...
            {[
              {
                ...
                desc: "Providing digital services worldwide.",
                icon: <Globe size={20} />,
              },
              {
                title: "Reliability",
                desc: "Committed to high-quality results.",
                icon: <Star size={20} />,
              },
              {
                title: "Growth Focused",
                desc: "Your business growth is our priority.",
                icon: <Zap size={20} />,
              },
            ].map((item, i) => (
              <motion.div
