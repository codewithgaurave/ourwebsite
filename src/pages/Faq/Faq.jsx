      ...
      items: [
        {
          ...
          a: "Yes, we develop native and cross-platform mobile applications for iOS and Android using React Native, Flutter, and native technologies like Swift and Kotlin.",
        },
        {
          q: "How long does it take to build a mobile app?",
          a: "Mobile app development timelines vary based on complexity. Simple apps may take 4-8 weeks, while complex apps with advanced features may take 3-6 months.",
        },
        {
          q: "Do you provide app maintenance and updates?",
          a: "Yes, we offer ongoing maintenance, bug fixes, performance optimization, and feature updates to keep your app running smoothly.",
        },
      ],
    },
    {
      ...
      items: [
        {
          q: "Do you build RESTful APIs and GraphQL services?",
          a: "Yes, we design and develop RESTful APIs and GraphQL services with proper authentication, documentation, and scalability in mind.",
        },
        {
          q: "What cloud platforms do you work with?",
          a: "We work with major cloud platforms including AWS, Azure, and Google Cloud. We help businesses migrate to the cloud and build scalable cloud-native applications.",
        },
        {
          q: "Do you provide DevOps and CI/CD services?",
          a: "Yes, we offer DevOps services including CI/CD pipeline setup, containerization with Docker, orchestration with Kubernetes, and infrastructure automation using Terraform.",
        },
      ],
    },
    {
      ...
      items: [
        {
          q: "Do you develop blockchain applications?",
          a: "Yes, we develop decentralized applications (DApps), smart contracts using Solidity, and integrate blockchain solutions for various industries including finance and supply chain.",
        },
        {
          q: "Do you provide game development services?",
          a: "Yes, we develop 2D and 3D games using Unity and Unreal Engine. Our game development services include concept design, development, testing, and deployment.",
        },
        {
          q: "What technologies do you use for desktop applications?",
          a: "We build cross-platform desktop applications using Electron, Qt, and .NET, providing modern UI/UX and native performance.",
        },
      ],
    },
    {
