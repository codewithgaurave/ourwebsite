      ...
      <main className="pt-32 pb-20 overflow-hidden">
        ...
        <section className="px-6 md:px-10 max-w-[1440px] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative rounded-[3.5rem] overflow-hidden bg-linear-to-br from-[#1a0b2e] to-[#0a0510] border border-violet-500/20 p-12 md:p-24 text-center group"
          >
            <div className="relative z-10">
              ...
              <button className="px-10 py-5 bg-linear-to-r from-violet-600 to-purple-600 rounded-full text-white font-bold text-lg hover:shadow-[0_0_40px_rgba(139,92,246,0.5)] transform hover:scale-105 transition-all outline-none">
                Start Your Project
              </button>
            </div>
          </motion.div>
