...
const DevOpsServices = () => {
  ...
  const technologies = [
    ...
    { name: "Jenkins", color: "from-red-500/20 to-transparent" },
    { name: "GitHub Actions", color: "from-gray-500/20 to-transparent" },
    { name: "Terraform", color: "from-purple-500/20 to-transparent" },
    { name: "Ansible", color: "from-red-600/20 to-transparent" }
  ];
          ...
          >
            ...
            <div className="max-w-4xl mx-auto relative z-10">
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-linear-to-r from-emerald-500/20 to-green-500/20 border border-white/10 text-white text-xs md:text-sm font-bold tracking-[0.2em] uppercase mb-8">
                <Settings size={18} className="text-emerald-400" /> DevOps Services
              </div>
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-10 mx-auto">
                We implement CI/CD pipelines, infrastructure automation, and containerization. 
                We streamline development workflows for faster and more reliable deployments.
              </p>
            </div>
          </motion.div>
        </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-gray-300 text-xl leading-relaxed mb-10">
                Our DevOps services cover everything from simple CI/CD pipelines to complex 
                infrastructure automation, ensuring your development process is efficient.
              </p>
            ...
            >
              ...
              <div className="relative z-10 p-10 md:p-16 rounded-[3rem] bg-white/5 border border-white/10 backdrop-blur-sm">
                <Settings size={120} className="text-emerald-400/30 mx-auto mb-6" />
                <h3 className="text-white font-bold text-2xl text-center mb-4">Automated & Efficient</h3>
                <p className="text-gray-400 text-center">
                  We build DevOps pipelines that automate your development process and improve efficiency.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <section className="px-6 md:px-10 max-w-[1440px] mx-auto mb-32">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              We leverage the latest DevOps technologies to build high-performance pipelines.
            </p>
          </motion.div>
