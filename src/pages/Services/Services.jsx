...
const Services = () => {
  ...
  const servicesList = [
    ...
    },
    {
      ...
      subtitle: "Modern Website & Web Application Development",
      desc: "We build responsive, high-performance websites that enhance user experience and convert visitors into customers. Our websites are optimized for speed, security, and SEO performance.",
