...
const SoftwareDevelopment = () => {
  ...
  return (
    ...
    <motion.div
      ...
      viewport={{ once: true }}
      className="relative rounded-[3.5rem] overflow-hidden bg-linear-to-br from-[#1a0b2e] to-[#0a0510] border border-purple-500/20 p-8 md:p-24 text-center group"
    >
      <div className="relative z-10">
        ...
        <a 
          href="https://wa.me/917610000127?text=Hello!%20I%20want%20to%20enquire%20about%20Software%20Development%20services."
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-3 px-6 py-4 md:px-10 md:py-5 bg-linear-to-r from-purple-600 to-pink-600 rounded-full text-white font-bold text-base md:text-lg hover:shadow-[0_0_40px_rgba(168,85,247,0.5)] transform hover:scale-105 transition-all outline-none group whitespace-nowrap"
        >
